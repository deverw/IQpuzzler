...
parts2d{1}{1} = [[0 2] ; [0 1] ; [0 0] ; [1 0] ; [2 0]];    % mid blue, symmetric L
parts2d{2}{1} = [[0 1] ; [0 0] ; [1 0] ; [2 0] ; [3 0]];    % red, long L
parts2d{3}{1} = [[0 2] ; [0 1] ; [1 1] ; [1 0] ; [2 1]];    % orange
parts2d{4}{1} = [[0 0] ; [1 0] ; [1 1] ; [2 0]];            % dark green, T
parts2d{5}{1} = [[0 0] ; [1 0] ; [1 1] ; [2 1] ; [2 2]];    % magenta, M
parts2d{6}{1} = [[0 1] ; [0 0] ; [1 0] ; [2 0] ; [2 1]];    % light green, U 
parts2d{7}{1} = [[0 0] ; [0 1] ; [0 2] ; [0 3] ; [1 1]];    % yellow
parts2d{8}{1} = [[0 0] ; [0 1] ; [1 1] ; [1 2] ; [1 3]];    % pink
parts2d{9}{1} = [[0 0] ; [1 0] ; [2 0] ; [0 1] ; [1 1]];    % cyan
parts2d{10}{1} = [[0 0] ; [1 0] ; [1 1] ; [2 1]];           % dark red
parts2d{11}{1} = [[0 1] ; [0 0] ; [1 0] ; [2 0]];           % dark blue, L
parts2d{12}{1} = [[1 0] ; [0 0] ; [0 1]];                   % light blue, short L
...
outfile2D=fopen('original.2di','w');
...
outfile3D=fopen('original.3di','w');
